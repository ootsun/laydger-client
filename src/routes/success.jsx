      ...
      <Layout>
        <main className="flex justify-evenly">
          ...
          <div id="alert-additional-content-3"
               className="p-4 mb-4 border border-green-300 rounded-lg bg-green-50 max-w-sm" role="alert">
            ...
            <div className="mt-2 mb-4 text-sm text-green-700">
              Your product should be delivered at {payment.deliveryAddress} very soon.
            </div>
            <img className="rounded-t-lg" src={payment.product.imageUrl} alt=""/>
            <div className="p-5">
              <h5
            ...
            <div className="flex">
              <button type="button"
                      onClick={() => navigate('/')}
                      className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center">
